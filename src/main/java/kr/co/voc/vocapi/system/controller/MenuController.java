...
import kr.co.voc.vocapi.system.dto.AuthDto;
import kr.co.voc.vocapi.system.service.AuthService;
...
public class AuthController extends BaseController
{
    ...
    @PostMapping("/add")
    public ResponseObject insertAuth(HttpServletRequest req, @RequestBody AuthDto.Info param)
    {
    ...
    @PostMapping("/modify")
    public ResponseObject updateAuth(HttpServletRequest req, @RequestBody AuthDto.Info param)
    {
