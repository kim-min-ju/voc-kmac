...
import kr.co.voc.vocapi.system.mapper.AuthMapper;
...
public class AuthService extends BaseService
{
    ...
    public AuthDto.ListResponse getAuthList(AuthDto.Request param)
    {
        ...
        //long total = offset == -1 ? 0:mapper.getAuthListCount(param);
        ...
        return AuthDto.ListResponse
                ...
                .totalCount(total)
                .list(mapper.getAuthList(param, offset, param.getPageSize()))
                .build();
	}
