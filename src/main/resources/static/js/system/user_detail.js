...
let init = function(){
    ...
    makeDropdownList('COM999','USE_YN', $('#registForm').find('.d-useYn'));
...
let checkCompanyCode = function(){
    let param = {'companyCdForCheck': $('#registForm').find('#companyCd').val()};
...
let deleteData = function(){
    ...
    let url = '/kmacvoc/v1/company/remove/'+menuSeq;
